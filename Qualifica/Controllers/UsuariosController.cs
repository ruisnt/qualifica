...
namespace Qualifica.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,Nome,CPF,RG,Senha,Login,Tipo")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Nome,CPF,RG,Senha,Login,Tipo")] Usuario usuario)
        {
            if (id != usuario.id)
            {
                return NotFound();
